...
export const T = {
  en: {
    ...
    logout:"Log out",
    newJourney:"Start new journey", pastJourneys:"Past journeys",
    newJourneyTitle:"Start a new journey?",
    newJourneyMsg:"Your current plan and all its logs, measurements and chat will be saved to your journey history (view-only), and you'll start fresh with a new setup. Nothing is deleted.",
    newJourneyConfirm:"Yes, start fresh",
    pastJourneysTitle:"Past journeys",
    noJourneys:"No past journeys yet. When you start a new journey, your current one is archived here so you can always look back at it.",
    journeyView:"View", journeyViewing:"Viewing past journey", readOnlyBadge:"View only",
    close:"Close", back:"Back",
    deleteJourney:"Delete journey", deleteJourneyTitle:"Delete this journey?",
    deleteJourneyMsg:"This permanently removes this archived journey and its history. This cannot be undone.",
    deleteJourneyConfirm:"Delete journey",
    journeyEntries:"entries", journeyMeasurements:"measurements", journeyPresent:"present",
    journeyDetails:"Journey details", details:"Details",
    sectionProfile:"Profile", sectionProgram:"Program",
    startDateLabel:"Start date", endDateLabel:"End date", none:"None",
  ...
  he: {
    ...
    logout:"התנתק",
    newJourney:"התחל מסע חדש", pastJourneys:"מסעות קודמים",
    newJourneyTitle:"להתחיל מסע חדש?",
    newJourneyMsg:"התוכנית הנוכחית וכל היומנים, המדידות והשיחות שלה יישמרו בהיסטוריית המסעות שלך (לצפייה בלבד), ותתחיל מחדש עם הגדרה חדשה. שום דבר לא נמחק.",
    newJourneyConfirm:"כן, להתחיל מחדש",
    pastJourneysTitle:"מסעות קודמים",
    noJourneys:"אין עדיין מסעות קודמים. כשתתחיל מסע חדש, המסע הנוכחי יישמר כאן כדי שתמיד תוכל להסתכל עליו.",
    journeyView:"צפה", journeyViewing:"צפייה במסע קודם", readOnlyBadge:"צפייה בלבד",
    close:"סגור", back:"חזרה",
    deleteJourney:"מחק מסע", deleteJourneyTitle:"למחוק את המסע הזה?",
    deleteJourneyMsg:"פעולה זו תסיר לצמיתות את המסע השמור ואת ההיסטוריה שלו. לא ניתן לבטל.",
    deleteJourneyConfirm:"מחק מסע",
    journeyEntries:"רשומות", journeyMeasurements:"מדידות", journeyPresent:"נוכחי",
    journeyDetails:"פרטי המסע", details:"פרטים",
    sectionProfile:"פרופיל", sectionProgram:"תוכנית",
    startDateLabel:"תאריך התחלה", endDateLabel:"תאריך סיום", none:"אין",
    startingStats:"נתוני פתיחה",
